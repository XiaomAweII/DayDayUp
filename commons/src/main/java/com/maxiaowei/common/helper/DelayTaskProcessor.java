...
public class DelayTaskProcessor implements Runnable, DisposableBean {
    ...
    public static class DelayTask implements Delayed {
        ...
        public DelayTask(long taskExecutionTimeMs, Runnable task) {
            this.taskExecutionTimeMs = taskExecutionTimeMs;
            this.task = task;
        }

        public void setTaskExecutionTimeMs(long taskExecutionTimeMs) {
            this.taskExecutionTimeMs = taskExecutionTimeMs;
        }
        ...
        public long getDelay(TimeUnit unit) {
            return unit.convert(taskExecutionTimeMs - System.currentTimeMillis(), TimeUnit.MILLISECONDS);
        }

        @Override
        public int compareTo(Delayed o) {
            if (o instanceof DelayTask other) {
                return Long.compare(this.taskExecutionTimeMs, other.taskExecutionTimeMs);
            }
            return 0;
        }
    }
